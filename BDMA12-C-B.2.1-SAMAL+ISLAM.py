...
for index, row in df_node_papers.iterrows():
    ...
    g.add((paper_id, research.paper_title, title))
    g.add((paper_id, research.paper_abstract, abstract))
    g.add((paper_id, research.paper_pages, pages))
    g.add((paper_id, research.paper_DOI, doi))
    g.add((paper_id, research.paper_link, link))
    g.add((paper_id, research.paper_date, date))
...
for index, row in df_node_authors.iterrows():
    ...
    g.add((author_id, research.author_name, name))
    g.add((author_id, research.author_email, email))
...
for index, row in df_node_conferences.iterrows():
    ...
    g.add((conference_id, research.conference_name, name))
    g.add((conference_id, research.conference_year, year))
    g.add((conference_id, research.conference_venue, venue))
    g.add((conference_id, research.conference_issn, issn))
    g.add((conference_id, research.conference_url, url))
    g.add((conference_id, research.conference_edition, edition))
...
for index, row in df_node_workshops.iterrows():
    ...
    g.add((workshop_id, research.workshop_name, name))
    g.add((workshop_id, research.workshop_year, year))
    g.add((workshop_id, research.workshop_venue, venue))
    g.add((workshop_id, research.workshop_issn, issn))
    g.add((workshop_id, research.workshop_url, url))
    g.add((workshop_id, research.workshop_edition, edition))
...
for index, row in df_node_journals.iterrows():
    ...
    g.add((journal_id, research.journal_name, name))
    g.add((journal_id, research.journal_venue, venue))
    g.add((journal_id, research.journal_year, year))
    g.add((journal_id, research.journal_issn, issn))
    g.add((journal_id, research.journal_url, url))
    g.add((journal_id, research.journal_volume, volume))
...
for index, row in df_node_keywords.iterrows():
    ...
    g.add((keyword_id, research.keyword_name, name))
    g.add((keyword_id, research.keyword_domain, domain))
...
for index, row in df_node_proceedings.iterrows():
    ...
    g.add((proceeding_id, research.proceeding_name, name))
    g.add((proceeding_id, research.proceeding_city, city))
...
# adding paper_presented_in_conferences edge
...
filepath = os.path.join(directory, "abox.rdf")
